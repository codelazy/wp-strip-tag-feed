<?php
/**
 * Plugin Name: Strip Tags RSS Feed
 ...
 */
function register() {
	add_feed( 'strip-tags-feed', __NAMESPACE__ . '\generate_content' );
}
...
function generate_content() {
	...
	if ( file_exists( ABSPATH . 'wp-content/plugins/wp-strip-tag-feed/feed-rss2.php' ) ) {
		require( ABSPATH . 'wp-content/plugins/wp-strip-tag-feed/feed-rss2.php' );
	}
